...
namespace K12.Service.Learning.Modules
{
    public partial class ServiceLearningBatch : BaseForm
    {
        ...
        void BGW_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            //取得學生基本資料
            Dictionary<string, StudentRecord> StudentDic = GetStudentRecord(SLRecordList);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (UpDataList.Count > 0)
            {
                ...
                ApplicationLog.Log("服務學習批次修改", "更新", "服務學習記錄\n已更新" + UpDataList.Count + "筆資料");
                MsgBox.Show("儲存成功!!");
                RunSelect();
            }
            else
        ...
        private void 刪除選擇資料ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (dr == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                ApplicationLog.Log("服務學習批次修改", "刪除", "服務學習記錄\n已刪除" + list.Count + "筆資料");
                //刪除
